...
static int exynos_cfg_i2s_gpio(struct platform_device *pdev)
{
	...
	struct exynos_gpio_cfg exynos4_cfg[3] = {
        /*
         * The GPZ(5)/GPZ(6) is used to control the power of WiFi and BT.
         * Thus, the following statement should be removed.
         * The GPZ(5) is set in the max8997.c file and the GPZ(6) is set in the semco_a31.c file
         */

				{EXYNOS4_GPZ(0), 5, S3C_GPIO_SFN(2)},
				{EXYNOS4_GPC0(0), 5, S3C_GPIO_SFN(2)},
				{EXYNOS4_GPC1(0), 5, S3C_GPIO_SFN(2)}};
	struct exynos_gpio_cfg exynos5_cfg[3] = {
				{EXYNOS5_GPZ(0), 5, S3C_GPIO_SFN(2)},
