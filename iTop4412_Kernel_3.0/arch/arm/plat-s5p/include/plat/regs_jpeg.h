...
#define S5P_JPEG_OP_MEM_BA_REG		0x10
#define S5P_JPEG_IMAGE_SIZE_REG		0x14
#define S5P_JPEG_IMAGE_BA_PLANE_1_REG		0x18
#define S5P_JPEG_IMAGE_SO_PLANE_1_REG		0x1c
#define S5P_JPEG_IMAGE_PO_PLANE_1_REG		0x20
#define S5P_JPEG_IMAGE_BA_PLANE_2_REG		0x24
#define S5P_JPEG_IMAGE_SO_PLANE_2_REG		0x28
#define S5P_JPEG_IMAGE_PO_PLANE_2_REG		0x2c
#define S5P_JPEG_IMAGE_BA_PLANE_3_REG		0x30
#define S5P_JPEG_IMAGE_SO_PLANE_3_REG		0x34
#define S5P_JPEG_IMAGE_PO_PLANE_3_REG		0x38
#define S5P_JPEG_TB_SEL_REG		0x3C


#define S5P_JPEG_IMAGE_FMT_REG		0x40
...
#define S5P_JPEG_DEC_IMAGE_SIZE_REG		0x54
#define S5P_JPEG_DEC_IMAGE_FMT_REG		0x58
...
#define S5P_JPEG_CMOD_REG_MOD_SEL_GRAY		(0<<5)
#define S5P_JPEG_CMOD_REG_MOD_SEL_YCBCR444		(1<<5)
#define S5P_JPEG_CMOD_REG_MOD_SEL_YCBCR422		(2<<5)
#define S5P_JPEG_CMOD_REG_MOD_SEL_YCBCR420		(3<<5)


/* JPEG SW Reset Register bit */
#define S5P_JPEG_SW_RESET_REG_ENABLE			(1<<29)
