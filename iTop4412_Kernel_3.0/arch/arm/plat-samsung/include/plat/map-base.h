...
#define S3C_VA_KMSG_DUMP	S3C_ADDR(0x00600000)	/* kmsg 1M */
#define S3C_VA_LOGGER1_DUMP	S3C_ADDR(0x00700000)	/* logger 1M */
#define S3C_VA_LOGGER2_DUMP	S3C_ADDR(0x00800000)	/* logger 1M */
#endif
