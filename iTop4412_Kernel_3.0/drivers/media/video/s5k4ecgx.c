...
//	struct s5k4ecgx_regset_table ev[EV_MAX];
	struct s5k4ecgx_regset_table ev[10];//jmq.v4l2_ev_mode.EV_MAX is changed, not suitable here	
...
///	.init_reg_4 = S5K4ECGX_REGSET_TABLE(s5k4ecgx_init_reg4), //many add
	...
	.ev = {
		S5K4ECGX_REGSET(EV_MINUS_4+4, s5k4ecgx_EV_Minus_4),
		S5K4ECGX_REGSET(EV_MINUS_3+4, s5k4ecgx_EV_Minus_3),
		S5K4ECGX_REGSET(EV_MINUS_2+4, s5k4ecgx_EV_Minus_2),
		S5K4ECGX_REGSET(EV_MINUS_1+4, s5k4ecgx_EV_Minus_1),
		S5K4ECGX_REGSET(EV_DEFAULT+4, s5k4ecgx_EV_Default),
		S5K4ECGX_REGSET(EV_PLUS_1+4, s5k4ecgx_EV_Plus_1),
		S5K4ECGX_REGSET(EV_PLUS_2+4, s5k4ecgx_EV_Plus_2),
		S5K4ECGX_REGSET(EV_PLUS_3+4, s5k4ecgx_EV_Plus_3),
		S5K4ECGX_REGSET(EV_PLUS_4+4, s5k4ecgx_EV_Plus_4),
	},
	.metering = {
...
static int s5k4ecgx_s_fmt(struct v4l2_subdev *sd, struct v4l2_mbus_framefmt *fmt)
{
	struct s5k4ecgx_state *state =
		container_of(sd, struct s5k4ecgx_state, sd);
	struct i2c_client *client = v4l2_get_subdevdata(sd);
...
static const struct v4l2_subdev_video_ops s5k4ecgx_video_ops = {
	.s_mbus_fmt = s5k4ecgx_s_fmt, //many s_fmt->s_mbus_fmt
