...
#endif
{
	...
	switch (cmd)
	{
		...
		case UMP_IOC_HANDLE_GET:
			err = ump_secure_id_get_wrapper((u32 __user *)argument, session_data);
			break;
...
#ifndef CONFIG_GB_VIDEO_MALI400MP
...
EXPORT_SYMBOL(ump_dd_secure_id_get_from_vaddr);
