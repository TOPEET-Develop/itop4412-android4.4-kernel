...
/*
 * IOCTL operation; Return handle for specified UMP memory.
 */
int ump_secure_id_get_wrapper(u32 __user * argument, struct ump_session_data  * session_data)
{
	_ump_uk_vaddr_s user_interaction;
	...
	if (_ump_ukk_secure_id_get_from_vaddr( &user_interaction ) !=
							_MALI_OSK_ERR_OK)
		return -ENOENT;
